...
Tournament.where(name: "Q1 2020 Double Elimination Tournament", tournament_type: 2, number_of_players: 29, winner: nil, runner_up: nil, active: false, elimination_type: 1, start_time: DateTime.new(2020,2,1)).first_or_create!
